...
<body class="boxed" data-bg-img="img/bg-pattern.png">
    ...
    <div class="wrapper">
              ...
              >
                ...
                <li class="dropdown megamenu filter">
                  <a
                    ...
                    >আন্তর্জাতিক<i class="fa flm fa-angle-down"></i
                  ></a>
                          ...
                          <div class="megamenu--filter">
                            <ul class="nav">
                              <li class="active">
                                <a
                                  href="#"
                                  data-action="load_cat_posts"
                                  data-cat="all"
                                  >All<i class="fa fa-angle-right"></i
                                ></a>
                              </li>
                              <li>
                                <a
                              ...
                              <li>
                                <a
                                  href="#"
                                  data-action="load_cat_posts"
                                  data-cat="middle-east"
                                  >Middle East<i class="fa fa-angle-right"></i
                                ></a>
                              </li>
                              <li>
                                <a
                        ...
                        <div class="col-md-10">
                            ...
                            <ul class="row" data-ajax-content="inner">
                              <li class="col-md-3">
                                <div class="img">
                                  ...
                                  >
                                    <img
                                      src="img/megamenu-img/post-01.jpg"
                                      alt=""
                                    />
                                  </a>
                              ...
                              <li class="col-md-3">
                                <div class="img">
                                  ...
                                  >
                                    <img
                                      src="img/megamenu-img/post-02.jpg"
                                      alt=""
                                    />
                                  </a>
                              ...
                              <li class="col-md-3">
                                <div class="img">
                                  ...
                                  >
                                    <img
                                      src="img/megamenu-img/post-03.jpg"
                                      alt=""
                                    />
                                  </a>
                              ...
                              <li class="col-md-3">
                                <div class="img">
                                  ...
                                  >
                                    <img
                                      src="img/megamenu-img/post-04.jpg"
                                      alt=""
                                    />
                                  </a>
                          ...
                          <div class="megamenu--pagination" data-ajax="tab">
                            <a
                              href="#"
                              class="prev"
                              data-ajax-action="load_prev_posts"
                            >
                            ...
                            <a
                              href="#"
                              class="next"
                              data-ajax-action="load_next_posts"
                            >
                ...
                <li class="dropdown">
                  <a href="#" class="dropdown-toggle" data-toggle="dropdown"
                    >ধর্ম<i class="fa flm fa-angle-down"></i
                  ></a>
                ...
                <li class="dropdown megamenu">
                  <a href="#" class="dropdown-toggle" data-toggle="dropdown"
                    >অন্যান্য<i class="fa flm fa-angle-down"></i
                  ></a>
        ...
        <div class="news--ticker">
            <div class="container">
                ...
                <div class="news-updates--list" data-marquee="true">
                    <ul class="nav">
                        <li>
                            <h3 class="h3"><a href="#">খাগড়াছড়িতে সহিংসতা ‘ওরা আমার নতুন বইও পুড়িয়ে দিল’</a></h3>
                        </li>
                        <li>
                            <h3 class="h3"><a href="#">গাজায় ‘তাৎক্ষণিকভাবে’ যুদ্ধ বন্ধে ট্রাম্পের ঘোষিত ২০ দফা পরিকল্পনায় কী আছে</a></h3>
                        </li>
                        <li>
                            <h3 class="h3"><a href="#">যে শর্তে সূর্যকুমারদের ট্রফি ফিরিয়ে দেবেন নাকভি</a></h3>
                        </li>
                        <li>
                            <h3 class="h3"><a href="#">সাকিবকে আর কখনো বাংলাদেশের হয়ে খেলতে দেওয়া হবে না, বললেন ক্রীড়া উপদেষ্টা আসিফ</a></h3>
                        </li>
                        <li>
                            <h3 class="h3"><a href="#">মিথিলার পাসপোর্টে কি সৃজিতের নাম আছে?</a></h3>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="main--breadcrumb">
            <div class="container">
                <ul class="breadcrumb">
                    <li><a href="home-1-boxed.html" class="btn-link"><i class="fa fm fa-home"></i>হোম</a></li>
                        ...
                        <div class="row gutter--15">
                                ...
                                <div class="row gutter--15">
                                    <div class="col-md-12 col-xs-6 col-xxs-12">
                                        ...
                                        <div class="post--item post--layout-1 post--title-large">
                                            <div class="post--img">
                                                <a href="news-single-v1-boxed.html" class="thumb"><img src="img/technology-img/banner-01.jpg" alt=""></a>
                                    ...
                                    <div class="col-md-12 col-xs-6 hidden-xxs">
                                        ...
                                        <div class="post--item post--layout-1 post--title-large">
                                            <div class="post--img">
                                                <a href="news-single-v1-boxed.html" class="thumb"><img src="img/technology-img/banner-02.jpg" alt=""></a>
                                                <a href="#" class="cat">Gadget</a>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="post--item post--layout-1 post--title-larger">
                                    <div class="post--img">
                                        <a href="news-single-v1-boxed.html" class="thumb"><img src="img/technology-img/banner-03.jpg" alt=""></a>
                            ...
                            <div class="col-md-3">
                                <div class="row gutter--15">
                                    <div class="col-md-12 col-xs-6 col-xxs-12">
                                        ...
                                        <div class="post--item post--layout-1 post--title-large">
                                            <div class="post--img">
                                                <a href="news-single-v1-boxed.html" class="thumb"><img src="img/technology-img/banner-04.jpg" alt=""></a>
                                                <a href="#" class="cat">Gadget</a>
                                                <a href="#" class="icon"><i class="fa fa-flash"></i></a>
                                    ...
                                    <div class="col-md-12 col-xs-6 hidden-xxs">
                                        ...
                                        <div class="post--item post--layout-1 post--title-large">
                                            <div class="post--img">
                                                <a href="news-single-v1-boxed.html" class="thumb"><img src="img/technology-img/banner-05.jpg" alt=""></a>
                                                <a href="#" class="cat">Magazine</a>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 ptop--30 pbottom--30">
                                    ...
                                    <div class="post--items-title" data-ajax="tab">
                                        ...
                                        <div class="nav">
                                            <a href="#" class="prev btn-link" data-ajax-action="load_prev_online_posts">
                                                <i class="fa fa-long-arrow-left"></i>
                                            </a>

                                            <span class="divider">/</span>

                                            <a href="#" class="next btn-link" data-ajax-action="load_next_online_posts">
                                                <i class="fa fa-long-arrow-right"></i>
                                            </a>
                                        </div>
                                    </div>
                                        ...
                                        <ul class="nav" data-ajax-content="inner">
                                            <li>
                                                ...
                                                <div class="post--item post--layout-1">
                                                    <div class="post--img">
                                                        <a href="news-single-v1-boxed.html" class="thumb"><img src="img/technology-img/online-01.jpg" alt=""></a>
                                                        <a href="#" class="cat">Online</a>
                                                        <a href="#" class="icon"><i class="fa fa-flash"></i></a>
                                                        ...
                                                        <div class="post--info">
                                                            ...
                                                            <div class="title">
                                                                <h3 class="h4"><a href="news-single-v1-boxed.html" class="btn-link">On the other hand, we denounce with righteous indignation and dislike demoralized</a></h3>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="post--action">
                                                        <a href="news-single-v1-boxed.html">Continue Reading... </a>
                                                    </div>
                                                </div>
                                                <!-- Post Item End -->
                                            </li>
                                            ...
                                            <li>
                                                ...
                                                <div class="post--item post--layout-1">
                                                    <div class="post--img">
                                                        <a href="news-single-v1-boxed.html" class="thumb"><img src="img/technology-img/online-02.jpg" alt=""></a>
                                                        <a href="#" class="cat">Online</a>
                                                        <a href="#" class="icon"><i class="fa fa-flash"></i></a>
                                ...
                                <div class="col-md-6 ptop--30 pbottom--30">
                                    ...
                                    <div class="post--items-title" data-ajax="tab">
                                        ...
                                        <div class="nav">
                                            <a href="#" class="prev btn-link" data-ajax-action="load_prev_gadgets_posts">
                                                <i class="fa fa-long-arrow-left"></i>
                                            </a>

                                            <span class="divider">/</span>

                                            <a href="#" class="next btn-link" data-ajax-action="load_next_gadgets_posts">
                                                <i class="fa fa-long-arrow-right"></i>
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="post--items post--items-3" data-ajax-content="outer">
                                        <ul class="nav" data-ajax-content="inner">
                                            <li>
                                                ...
                                                <div class="post--item post--layout-1">
                                                    <div class="post--img">
                                                        <a href="news-single-v1-boxed.html" class="thumb"><img src="img/technology-img/gadgets-01.jpg" alt=""></a>
                                                        <a href="#" class="cat">Gadget</a>
                                            ...
                                            <li>
                                                ...
                                                <div class="post--item post--layout-3">
                                                    <div class="post--img">
                                                        <a href="news-single-v1-boxed.html" class="thumb"><img src="img/technology-img/gadgets-02.jpg" alt=""></a>
                                            ...
                                            <li>
                                                ...
                                                <div class="post--item post--layout-3">
                                                    <div class="post--img">
                                                        <a href="news-single-v1-boxed.html" class="thumb"><img src="img/technology-img/gadgets-03.jpg" alt=""></a>
                                            ...
                                            <li>
                                                ...
                                                <div class="post--item post--layout-3">
                                                    <div class="post--img">
                                                        <a href="news-single-v1-boxed.html" class="thumb"><img src="img/technology-img/gadgets-04.jpg" alt=""></a>
                                            ...
                                            <li>
                                                ...
                                                <div class="post--item post--layout-3">
                                                    <div class="post--img">
                                                        <a href="news-single-v1-boxed.html" class="thumb"><img src="img/technology-img/gadgets-05.jpg" alt=""></a>
                                ...
                                <div class="col-md-12 ptop--30 pbottom--30">
                                    ...
                                    <div class="post--items-title" data-ajax="tab">
                                        ...
                                        <div class="nav">
                                            <a href="#" class="prev btn-link" data-ajax-action="load_prev_multimedia_posts">
                                                <i class="fa fa-long-arrow-left"></i>
                                            </a>

                                            <span class="divider">/</span>

                                            <a href="#" class="next btn-link" data-ajax-action="load_next_multimedia_posts">
                                                <i class="fa fa-long-arrow-right"></i>
                                            </a>
                                        </div>
                                    </div>
                                        ...
                                        <ul class="nav row" data-ajax-content="inner">
                                            <li class="col-md-12">
                                                ...
                                                <div class="post--item">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="post--img">
                                                                <a href="news-single-v1-boxed.html" class="thumb"><img src="img/technology-img/multimedia-01.jpg" alt=""></a>
                                                                <a href="#" class="cat">Computer</a>
                                                                <a href="#" class="icon"><i class="fa fa-star-o"></i></a>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="post--info">
                                                                ...
                                                                <div class="title">
                                                                    <h3 class="h4"><a href="news-single-v1-boxed.html" class="btn-link">At vero eos et accusamus et iusto odio dignissimos uniti atque corrupti quos dolores et quas.</a></h3>
                                                                </div>
                                                            </div>
                                            ...
                                            <li class="col-md-6">
                                                ...
                                                <div class="post--item post--layout-4">
                                                    <div class="post--img">
                                                        <a href="news-single-v1-boxed.html" class="thumb"><img src="img/technology-img/multimedia-02.jpg" alt=""></a>
                                            ...
                                            <li class="col-md-6">
                                                ...
                                                <div class="post--item post--layout-4">
                                                    <div class="post--img">
                                                        <a href="news-single-v1-boxed.html" class="thumb"><img src="img/technology-img/multimedia-03.jpg" alt=""></a>
                                            ...
                                            <li class="col-md-6">
                                                ...
                                                <div class="post--item post--layout-4">
                                                    <div class="post--img">
                                                        <a href="news-single-v1-boxed.html" class="thumb"><img src="img/technology-img/multimedia-04.jpg" alt=""></a>
                                            ...
                                            <li class="col-md-6">
                                                ...
                                                <div class="post--item post--layout-4">
                                                    <div class="post--img">
                                                        <a href="news-single-v1-boxed.html" class="thumb"><img src="img/technology-img/multimedia-05.jpg" alt=""></a>
                                ...
                                <div class="col-md-6 ptop--30 pbottom--30">
                                    ...
                                    <div class="post--items-title" data-ajax="tab">
                                        ...
                                        <div class="nav">
                                            <a href="#" class="prev btn-link" data-ajax-action="load_prev_science_posts">
                                                <i class="fa fa-long-arrow-left"></i>
                                            </a>

                                            <span class="divider">/</span>

                                            <a href="#" class="next btn-link" data-ajax-action="load_next_science_posts">
                                                <i class="fa fa-long-arrow-right"></i>
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="post--items post--items-2" data-ajax-content="outer">
                                        <ul class="nav" data-ajax-content="inner">
                                            <li>
                                                ...
                                                <div class="post--item post--layout-1">
                                                    <div class="post--img">
                                                        <a href="news-single-v1-boxed.html" class="thumb"><img src="img/technology-img/science-01.jpg" alt=""></a>
                                                        <a href="#" class="cat">Satellite</a>
                                                        <a href="#" class="icon"><i class="fa fa-flash"></i></a>
                                            ...
                                            <li>
                                                ...
                                                <div class="post--item post--layout-1">
                                                    <div class="post--img">
                                                        <a href="news-single-v1-boxed.html" class="thumb"><img src="img/technology-img/science-02.jpg" alt=""></a>
                                                        <a href="#" class="cat">Satellite</a>
                                                        <a href="#" class="icon"><i class="fa fa-flash"></i></a>
                                ...
                                <div class="col-md-6 ptop--30 pbottom--30">
                                    ...
                                    <div class="post--items-title" data-ajax="tab">
                                        ...
                                        <div class="nav">
                                            <a href="#" class="prev btn-link" data-ajax-action="load_prev_research_posts">
                                                <i class="fa fa-long-arrow-left"></i>
                                            </a>

                                            <span class="divider">/</span>

                                            <a href="#" class="next btn-link" data-ajax-action="load_next_research_posts">
                                                <i class="fa fa-long-arrow-right"></i>
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="post--items post--items-2" data-ajax-content="outer">
                                        <ul class="nav" data-ajax-content="inner">
                                            <li>
                                                ...
                                                <div class="post--item post--layout-1">
                                                    <div class="post--img">
                                                        <a href="news-single-v1-boxed.html" class="thumb"><img src="img/technology-img/research-01.jpg" alt=""></a>
                                                        <a href="#" class="cat">Chemist</a>
                                                        <a href="#" class="icon"><i class="fa fa-flash"></i></a>
                                            ...
                                            <li>
                                                ...
                                                <div class="post--item post--layout-1">
                                                    <div class="post--img">
                                                        <a href="news-single-v1-boxed.html" class="thumb"><img src="img/technology-img/research-02.jpg" alt=""></a>
                                                        <a href="#" class="cat">Chemist</a>
                                                        <a href="#" class="icon"><i class="fa fa-flash"></i></a>
                        ...
                        <ul class="nav row" data-ajax-content="inner">
                            <li class="col-md-8">
                                ...
                                <div class="post--item post--layout-1 post--type-video post--title-large">
                                    <div class="post--img">
                                        <a href="news-single-v1-boxed.html" class="thumb"><img src="img/technology-img/audio-video-01.jpg" alt=""></a>
                                        <a href="#" class="cat">Computer</a>
                                ...
                                <ul class="nav">
                                    <li>
                                        ...
                                        <div class="post--item post--type-audio post--layout-3">
                                            <div class="post--img">
                                                <a href="news-single-v1-boxed.html" class="thumb"><img src="img/technology-img/audio-video-02.jpg" alt=""></a>
                                    ...
                                    <li>
                                        ...
                                        <div class="post--item post--type-video post--layout-3">
                                            <div class="post--img">
                                                <a href="news-single-v1-boxed.html" class="thumb"><img src="img/technology-img/audio-video-03.jpg" alt=""></a>
                                    ...
                                    <li>
                                        ...
                                        <div class="post--item post--type-audio post--layout-3">
                                            <div class="post--img">
                                                <a href="news-single-v1-boxed.html" class="thumb"><img src="img/technology-img/audio-video-04.jpg" alt=""></a>
                                    ...
                                    <li>
                                        ...
                                        <div class="post--item post--type-video post--layout-3">
                                            <div class="post--img">
                                                <a href="news-single-v1-boxed.html" class="thumb"><img src="img/technology-img/audio-video-05.jpg" alt=""></a>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 ptop--30 pbottom--30">
                                    ...
                                    <div class="post--items-title" data-ajax="tab">
                                        ...
                                        <div class="nav">
                                            <a href="#" class="prev btn-link" data-ajax-action="load_prev_games_posts">
                                                <i class="fa fa-long-arrow-left"></i>
                                            </a>

                                            <span class="divider">/</span>

                                            <a href="#" class="next btn-link" data-ajax-action="load_next_games_posts">
                                                <i class="fa fa-long-arrow-right"></i>
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="post--items" data-ajax-content="outer">
                                        <ul class="nav row gutter--15" data-ajax-content="inner">
                                            <li class="col-md-4 col-xs-6 col-xxs-12">
                                                ...
                                                <div class="post--item post--layout-1">
                                                    <div class="post--img">
                                                        <a href="news-single-v1-boxed.html" class="thumb"><img src="img/technology-img/games-01.jpg" alt=""></a>
                                            ...
                                            <li class="col-md-4 col-xs-6 col-xxs-12">
                                                ...
                                                <div class="post--item post--layout-1">
                                                    <div class="post--img">
                                                        <a href="news-single-v1-boxed.html" class="thumb"><img src="img/technology-img/games-02.jpg" alt=""></a>
                                            ...
                                            <li class="col-md-4 hidden-sm hidden-xs">
                                                ...
                                                <div class="post--item post--layout-1">
                                                    <div class="post--img">
                                                        <a href="news-single-v1-boxed.html" class="thumb"><img src="img/technology-img/games-03.jpg" alt=""></a>
                                            ...
                                            <li>
                                                ...
                                                <div class="post--item">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="post--img">
                                                                <a href="news-single-v1-boxed.html" class="thumb"><img src="img/technology-img/automobile-01.jpg" alt=""></a>
                                                                <a href="#" class="cat">Automobile</a>
                                                                <a href="#" class="icon"><i class="fa fa-star-o"></i></a>
                                                            </div>
                                                        </div>
                                            ...
                                            <li>
                                                ...
                                                <div class="post--item">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="post--img">
                                                                <a href="news-single-v1-boxed.html" class="thumb"><img src="img/technology-img/automobile-02.jpg" alt=""></a>
                                                                <a href="#" class="cat">Automobile</a>
                                                                <a href="#" class="icon"><i class="fa fa-flash"></i></a>
                                                            </div>
                                                        </div>
                                            ...
                                            <li>
                                                ...
                                                <div class="post--item">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="post--img">
                                                                <a href="news-single-v1-boxed.html" class="thumb"><img src="img/technology-img/automobile-03.jpg" alt=""></a>
                                                                <a href="#" class="cat">Automobile</a>
                                                                <a href="#" class="icon"><i class="fa fa-heart-o"></i></a>
                                                            </div>
                                                        </div>
                                    ...
                                    <div class="post--items post--items-1" data-ajax-content="outer">
                                        <ul class="nav row gutter--15" data-ajax-content="inner">
                                            <li class="col-md-12">
                                                ...
                                                <div class="post--item post--layout-1 post--title-large">
                                                    <div class="post--img">
                                                        <a href="news-single-v1-boxed.html" class="thumb"><img src="img/technology-img/photo-gallery-01.jpg" alt=""></a>
                                                        <a href="#" class="cat">Chemist</a>
                                                        <a href="#" class="icon"><i class="fa fa-eye"></i></a>
                                            ...
                                            <li class="col-md-4 col-xs-6 col-xxs-12">
                                                ...
                                                <div class="post--item post--layout-1">
                                                    <div class="post--img">
                                                        <a href="news-single-v1-boxed.html" class="thumb"><img src="img/technology-img/photo-gallery-02.jpg" alt=""></a>
                                            ...
                                            <li class="col-md-4 col-xs-6 col-xxs-12">
                                                ...
                                                <div class="post--item post--layout-1">
                                                    <div class="post--img">
                                                        <a href="news-single-v1-boxed.html" class="thumb"><img src="img/technology-img/photo-gallery-03.jpg" alt=""></a>
                                            ...
                                            <li class="col-md-4 hidden-sm hidden-xs">
                                                ...
                                                <div class="post--item post--layout-1">
                                                    <div class="post--img">
                                                        <a href="news-single-v1-boxed.html" class="thumb"><img src="img/technology-img/photo-gallery-04.jpg" alt=""></a>
        ...
        <footer class="footer--section">
            ...
            <div class="footer--copyright bg--color-3">
                ...
                <div class="container">
                    <p class="text float--left">&copy; <span class="copyright-year">2017</span> <a href="#"> </a>. All Rights Reserved to Time Vision 24</p>
